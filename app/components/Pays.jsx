      ...
      <Link href={"/"}>
       <div className="md:flex items-start justify-between w-full md:pl-[71.8px] md:pt-[71.8px] p-[34px] pb-0 pr-1 h-full greengrid2 hover:shadow-md transition-all ease-in-out overflow-clip">
            <div className="w-full md:w-1/3">
                ...
                <p className="md:text-[19px] text-[16px] flex transition-all ease-in-out font-grey-med text-white/90 items-center gap-3 text-start mt-[22px] md:mt-[100px] h-fit w-[35%] leading-[26px]">Get Spot  <IoArrowForwardCircleOutline className=" text-[25px]" /> </p>
            </div>
