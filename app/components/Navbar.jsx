...
const Navbar = () => {
  ...
  return (
    <section className="w-full  mx-auto  font-grey-med  md:w-[1200px] md:max-w-[1200px] h-fit">
        <nav  className={fix ? 'md:fixed h-fit z-50 text-white/80 pr-4 bg-black/70 rounded-b-[20px] mx-auto md:w-[1200px]' : 'md:fixed text-white pr-4 bg-transparent h-fit z-50 mx-auto md:w-[1200px]'}>
